...
export function useScenarioEditorI18n() {
  ...
  en: {
    scenarioEditor: {
      ...
      offChainStepsAppended: '{count} step(s) were not connected to the scenario and have been placed at the end of the sequence. Wire them where you want them and save again.',
      platform: 'Platform',
  ...
  fr: {
    scenarioEditor: {
      ...
      offChainStepsAppended: "{count} étape(s) n'étaient pas reliées au scénario et ont été placées à la fin de la séquence. Reliez-les où vous le souhaitez puis enregistrez à nouveau.",
      platform: 'Plateforme',
