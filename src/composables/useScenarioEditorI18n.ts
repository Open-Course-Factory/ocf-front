...
export function useScenarioEditorI18n() {
  ...
  en: {
    scenarioEditor: {
      ...
      orderSyncFailed: '{count} step order(s) could not be saved — the step sequence may be inconsistent. Reload and save again.',
      platform: 'Platform',
  ...
  fr: {
    scenarioEditor: {
      ...
      orderSyncFailed: '{count} ordre(s) d\'étape n\'ont pas pu être enregistrés — la séquence est peut-être incohérente. Rechargez puis enregistrez à nouveau.',
      platform: 'Plateforme',
