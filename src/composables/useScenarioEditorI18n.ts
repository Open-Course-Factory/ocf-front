...
export function useScenarioEditorI18n() {
  ...
  en: {
    scenarioEditor: {
      ...
      sharedBody: 'Machine size, visibility, flags and the language list mean the same thing whatever language a learner reads in, so they are edited on the original. The setup script is not yet translatable — see the scenario notes.',
  ...
  fr: {
    scenarioEditor: {
      ...
      sharedBody: "La taille de machine, la visibilité, les drapeaux et la liste des langues signifient la même chose quelle que soit la langue de lecture : ils se modifient sur l'original. Le script de préparation n'est pas encore traduisible.",
