...
export function useScenarioEditorI18n() {
  ...
  en: {
    scenarioEditor: {
      ...
      stepLayoutFollowsOrder: 'Steps are laid out left to right in their run order, so the horizontal position you had saved was not restored. Their vertical position was kept.',
  ...
  fr: {
    scenarioEditor: {
      ...
      stepLayoutFollowsOrder: "Les étapes sont disposées de gauche à droite dans leur ordre d'exécution : la position horizontale que vous aviez enregistrée n'a pas été restaurée. Leur position verticale est conservée.",
