...
export function useScenarioEditorI18n() {
  ...
  en: {
    scenarioEditor: {
      ...
      copyToOrg: 'Copy to an organization or a class',
      archive: 'Archive',
      unarchive: 'Restore',
      archived: 'Archived',
      ...
      selectTargetOrg: 'Where to put the copy',
      ...
      portExposureAllowed: 'Allow public port exposure',
      ...
      previewErrorUnknownStep: 'This step no longer exists in the saved scenario. Reload the scenario, then try again.',
  ...
  fr: {
    scenarioEditor: {
      ...
      copyToOrg: 'Copier vers une organisation ou une classe',
      archive: 'Archiver',
      unarchive: 'Restaurer',
      archived: 'Archivé',
      ...
      selectTargetOrg: 'Où placer la copie',
      ...
      portExposureAllowed: 'Autoriser l’exposition publique de ports',
      ...
      previewErrorUnknownStep: "Cette étape n'existe plus dans le scénario enregistré. Rechargez le scénario, puis réessayez.",
