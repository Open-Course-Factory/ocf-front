...
export const useScenariosStore = defineStore('scenarios', () => {
    ...
    const { t } = useStoreTranslations({
        en: {
            scenarios: {
                ...
                portExposureAllowed: 'Public Port Exposure',
                port_exposure_allowed: 'Public Port Exposure',
        ...
        fr: {
            scenarios: {
                ...
                estimated_time_minutes: 'Durée estimée (minutes)',
                ...
                portExposureAllowed: 'Exposition publique de ports',
                port_exposure_allowed: 'Exposition publique de ports',
    ...
    const fieldList = computed(() => buildFieldList([
        ...
        field('estimated_time_minutes', t('scenarios.estimatedTimeMinutes')).input().visible().creatable().updatable(),
