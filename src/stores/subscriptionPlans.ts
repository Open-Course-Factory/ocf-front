...
export const useSubscriptionPlansStore = defineStore('subscriptionPlans', () => {
    ...
    const { t } = useStoreTranslations({
        ...
        subscriptionPlans: {
            ...
            personalFallback: 'Using your personal subscription',
            personalFallbackDescription: 'This organization does not have its own subscription. Your personal subscription is being used instead.',
            ...
            subscriptionType_organization: 'Organization',
            ...
            port_exposure_ttl_minutes: 'Exposed URL Lifetime (min)',
        ...
        fr: {
            ...
            personalFallback: 'Utilisation de votre abonnement personnel',
            personalFallbackDescription: 'Cette organisation ne dispose pas de son propre abonnement. Votre abonnement personnel est utilisé à la place.',
            ...
            subscriptionType_organization: 'Organisation',
            ...
            port_exposure_ttl_minutes: 'Durée de vie d’une URL exposée (min)',
    ...
    const fieldList = computed(() => buildFieldList([
        ...
        field('port_exposure_ttl_minutes', t('subscriptionPlans.port_exposure_ttl_minutes')).input().visible().readonly(),
        ...
        field('default_backend', t('subscriptionPlans.default_backend')).input().visible().readonly(),
        ...
        field('created_at', t('subscriptionPlans.created_at')).input().visible().readonly(),
        field('updated_at', t('subscriptionPlans.updated_at')).input().visible().readonly()
    ]))
