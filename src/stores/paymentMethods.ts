...
export const usePaymentMethodsStore = defineStore('paymentMethods', () => {
    ...
    // Synchroniser et charger les méthodes de paiement (utilise le wrapper réutilisable)
    const { sync: syncPaymentMethods, load: loadUserPaymentMethods, syncAndLoad: syncAndLoadPaymentMethods } = createSyncAndLoadWrapper(
