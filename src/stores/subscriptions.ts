    ...
    const { t } = useStoreTranslations({
        en: {
            subscriptions: {
                ...
                prorationAlwaysInvoiceDesc: 'You will be charged a prorated amount immediately for this change.',
        ...
        fr: {
            subscriptions: {
                ...
                prorationAlwaysInvoiceDesc: 'Vous serez facturé au prorata immédiatement pour ce changement.',
