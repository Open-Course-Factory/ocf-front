...
const { t, te } = useTranslations({
  en: {
    terminalStarter: {
      ...
      searchInstances: 'Search machines...',
      noInstancesFound: 'No machines found',
      noMatchingInstances: 'No machines match "{searchTerm}"',
      noAvailableInstances: 'No machines available for your current plan.',
      allInstancesAvailable: 'All machines are available.',
  ...
  fr: {
    terminalStarter: {
      ...
      searchInstances: 'Rechercher des machines...',
      noInstancesFound: 'Aucune machine trouvée',
      noMatchingInstances: 'Aucune machine ne correspond à "{searchTerm}"',
      noAvailableInstances: 'Aucune machine disponible pour votre plan actuel.',
      allInstancesAvailable: 'Toutes les machines sont disponibles.',
