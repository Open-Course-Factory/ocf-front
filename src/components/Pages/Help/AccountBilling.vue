...
.address-importance ul {
  margin: 10px 0;
  padding-left: 20px;
  color: #555;
}

.address-importance li {
  margin-bottom: 5px;
  font-size: 0.9rem;
}
...
.issue-card.declined .issue-header {
  background: #f8d7da;
  color: #721c24;
}

.issue-card.retry .issue-header {
  background: #fff3cd;
  color: #856404;
}
...
.upcoming-billing-features h4 {
  margin: 0 0 10px 0;
  color: #333;
}

.upcoming-billing-features ul {
  margin: 0;
  padding-left: 20px;
  color: #555;
}

.upcoming-billing-features li {
  margin-bottom: 5px;
  font-size: 0.9rem;
}
