...
const basicRoutes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'scenarios', name: 'ScenarioLauncher', component: () => import('../components/Pages/ScenarioLauncher.vue'), meta: { requiresAuth: true } },
      ...
      { path: 'admin/platform-settings', name: 'AdminPlatformSettings', component: () => import('../components/Pages/Admin/PlatformSettings.vue'), meta: { requiresAuth: true, requiresAdmin: true } },
      { path: 'admin/distribution-catalog', name: 'AdminDistributionCatalog', component: () => import('../components/Pages/Admin/DistributionCatalog.vue'), meta: { requiresAuth: true, requiresAdmin: true } },
      ...
      {
        path: 'admin/plan-health',
        name: 'AdminPlanHealth',
        component: () => import('../components/Pages/Admin/PlanHealth.vue'),
        meta: { requiresAuth: true, requiresAdmin: true }
      },
      {
