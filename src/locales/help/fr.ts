  ...
  help: {
    ...
    account: {
      ...
      permissionsReference: {
        ...
        legendDescription: "Chaque endpoint API est protégé par deux couches : un rôle Casbin (member ou admin) qui contrôle l'accès HTTP, et une règle d'accès fine qui applique la logique métier.",
