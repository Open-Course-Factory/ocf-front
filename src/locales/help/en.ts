  ...
  help: {
    ...
    account: {
      ...
      permissionsReference: {
        ...
        legendDescription: "Each API endpoint is protected by two layers: a Casbin role (member or admin) that controls HTTP-level access, and a fine-grained access rule that enforces business logic.",
